this.getroottable().anatomists_expanded.hook_scenario <- function ()
{
	::mods_hookNewObject("skills/backgrounds/anatomist_background", function (o)
	{
		...
		{
			create();
			this.m.BackgroundDescription = "Part scientist and part surgeon, Anatomists are unaccustomed to battle but well served by steady hands. Each anatomist in your party gives a 5% chance to make a potion from an enemy's corpse after battle.";
			this.m.HiringCost = 1200;
			this.m.DailyCost = 20;
		}
	...
	::mods_hookExactClass("scenarios/world/anatomists_scenario", function (o)
	{
		...
		o.onSpawnAssets = function()
		{
			...
			this.World.Assets.getStash().add(this.new("scripts/items/misc/anatomist/necrosavant_lord_potion_item"));

			this.World.Assets.getStash().add(this.new("scripts/items/misc/anatomist/goblin_grunt_potion_item"));

			this.World.Assets.getStash().add(this.new("scripts/items/misc/anatomist/orc_young_potion_item"));
			this.World.Assets.getStash().add(this.new("scripts/items/misc/anatomist/orc_warlord_potion_item"));

			this.World.Assets.getStash().add(this.new("scripts/items/misc/anatomist/serpent_potion_item"));
