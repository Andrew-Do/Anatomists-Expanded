this.nightmare_player <- this.inherit("scripts/skills/skill", {
		...
		ret.extend([
			{
				...
				text = "Inflicts [color=" + this.Const.UI.Color.DamageValue + "]" + 10 + "[/color] - [color=" + this.Const.UI.Color.DamageValue + "]" + 30 + "[/color] mental damage to hitpoints"
			},
			{
				id = 7,
				type = "text",
	...
	function onDelayedEffect( _tag )
	{
		...
		hitInfo.DamageRegular = this.Math.rand(this.getDamage(target, 10), this.getDamage(target, 30));
